...
write.csv(dfm1, "DFM_1.csv", row.names = FALSE)
write.csv(dfm2, "DFM_2.csv", row.names = FALSE)
write.csv(dfm3, "DFM_3.csv", row.names = FALSE)
write.csv(dfm4, "DFM_4.csv", row.names = FALSE)
write.csv(dfm5, "DFM_5.csv", row.names = FALSE)